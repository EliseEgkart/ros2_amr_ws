    ...
    def timer_callback(self):
        ...
        if self.lifecycle == True:
            ...
            if self.first_loop_detect_leg is not True and self.step == 1:
                ...
                if (abs((self.x1_+self.x2_)/2) < 0.12 and 0.7 <((self.y1_+self.y2_)/2) < 0.92):
                ...
                if self.count_wait_between_1_2 > 20:
                    self.step = 3
    ...
    def lqr_command(self,msg):
        ...
        if (self.step == 2):
            ...
            if(self.count_step3 > 10): 
                ...
                if (abs((self.x1+self.x2)/2) < 0.12 and 0.7 <((self.y1+self.y2)/2) < 0.92):
                    ...
                    if (self.count_step2 >= 2):
                        ...
                        self.get_logger().info(f'추정 (x,y) :{self.count_step2},{(self.x1_)}, {(self.y1_)},{(self.x2_)},{(self.y2_)}')
